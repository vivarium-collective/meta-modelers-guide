...
**Verified against installed code:** `cpm` (`/Users/eranagmon/code/viva-cpm/cpm/`, Rust `cpm_core`), `cobra` textbook `e_coli_core`, and the merged flagship `meta_modelers_guide/cpm/cell_field.py`.
**Interpreter:** `/Users/eranagmon/code/meta-modelers-guide/.venv/bin/python`, `PYTHONPATH=/Users/eranagmon/code/meta-modelers-guide--cpm-multicellular`.
