...
- Lead with the biology (self-maintaining boundary, operational closure, "a membrane alone is insufficient"). Cite by section title (§Self-organized processes) + beer2024deriving (viability bounds as constraints on shared state). Demote the composition framing to ≤1 sentence.
