...
- [ ] **Step 1:** Rebuild all executables + the playable disintegration composite: `PYTHONPATH=~/code/meta-modelers-guide--paper-aligned python scripts/build_executables.py && PYTHONPATH=~/code/meta-modelers-guide--paper-aligned python scripts/build_disintegration.py`.
